...
**Target project:** "Podscale" on claude.ai/design — projectId
...
- The design system lives in **`design/`**: `podscale.css` (the token +
...
(writes `podscale.css`, `index.html`, `README.md`, `components/*.html`;
